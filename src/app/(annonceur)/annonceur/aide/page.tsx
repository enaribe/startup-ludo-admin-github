...
const FAQ: Array<[string, string]> = [
  ...
  ['Comment arrêter une diffusion en cours ?', 'Le bouton « Mettre en pause » de votre écran de suivi arrête l’affichage immédiatement, et « Reprendre » le relance : vos mois réservés restent les vôtres pendant tout ce temps. Pour un arrêt DÉFINITIF, écrivez à annonceurs@concree.com — il libère vos mois, qui redeviennent disponibles pour d’autres structures, et cela ne se rattrape pas. Dans les deux cas vous ne payez que les vues réellement servies : s’arrêter plus tôt coûte simplement moins cher, il n’y a ni forfait ni pénalité.'],
