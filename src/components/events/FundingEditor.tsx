...
export default function FundingEditor({ funding, onSave, onClose, sectors }: FundingEditorProps) {
  const [formData, setFormData] = useState<Funding>({
    ...
    translations: funding?.translations,
  });
          ...
          <div className="flex flex-col gap-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder={lang === 'fr' ? 'Microcrédit startup' : 'English title…'}
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder={lang === 'fr' ? 'Vous avez obtenu un microcrédit de 500 000 FCFA...' : 'English description…'}
                rows={3}
                style={{ resize: 'vertical' }}
              />
            </div>

            {/* Champ masqué : non consommé par le mobile (points fixes côté jeu). */}
            ...
            {/* Champ masqué : non consommé par le mobile (source jamais utilisée). */}
          </div>
        </div>
